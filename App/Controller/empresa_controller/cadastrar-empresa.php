...
if(isset($_POST['razao_social']) && !empty($_POST['razao_social']) && isset($_POST['cnpj']) && !empty($_POST['cnpj'])
&& isset($_POST['proprietario_id']) && !empty($_POST['proprietario_id']) && isset($_POST['endereco']) && !empty($_POST['endereco'])
&& isset($_POST['complemento']) && !empty($_POST['complemento']) && isset($_POST['cidade'])
...
$e->setProprietarioId(addslashes($_POST['proprietario_id']));
